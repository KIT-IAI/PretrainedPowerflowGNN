...
def argument_parser():
    ...
    parser.add_argument('--grid_split', type=int, default=0, help='Split to use')
    ...
    # Training parameters
    parser.add_argument('--data-dir', type=str, default='datasets', help='Path to data directory')
    ...
    parser.add_argument('--use_pf_net', type=bool, default=True, help='whether use power flow net or ideal power flows', action=argparse.BooleanOptionalAction)
    parser.add_argument('--use_generalizing_net', type=bool, default=True, help='whether use generalizing net or grid trained on all topologies', action=argparse.BooleanOptionalAction)
    parser.add_argument('--use_coldstart', type=bool, default=False, help='whether use coldstart model', action=argparse.BooleanOptionalAction)
